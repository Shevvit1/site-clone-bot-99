        ...
        <div className="text-center space-y-6">
          ...
          <div className="flex justify-center items-center gap-8">
            <a
              ...
              className="w-14 h-14 rounded-full bg-[#1877F2] flex items-center justify-center hover:opacity-80 transition-opacity"
              aria-label="Facebook"
            >
            ...
            <a
              href="https://www.instagram.com/cleansofa_westmeath?igsh=ZTZsdXFsMTBrMDht"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-14 h-14 rounded-full bg-black flex items-center justify-center hover:opacity-80 transition-opacity"
              aria-label="TikTok"
            >
